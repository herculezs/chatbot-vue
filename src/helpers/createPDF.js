...
const pdf = {
  async saveCSVFile(chartComparePath, barChartPath, textCharacter,
    titleCharacter, reportPage = false, x1 = 10, x2 = 105) {
    ...
    return Promise.resolve(this.delay(1000).then(() => html2canvas(chartComparePath, {
      ...
      doc.addImage(canvas.toDataURL('image/jpeg'), 'JPEG', x1, 10, 100, 100);
      return html2canvas(barChartPath, {
        ...
        doc.addImage(img2.toDataURL('image/jpeg'), 'JPEG', x2, 10, 100, 100);
        // eslint-disable-next-line no-param-reassign
