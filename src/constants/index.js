export default {
  cards: {
    ...
    Aloof: {
      title: 'Aloof',
      tag: 'MBTI ESTP',
      showText: 'Although to others you may seems engaging and interactive, privately, you tend not to be interested in having many social relationships, preferring a more sheltered, private lifestyle.  We classify this type of personality as the <span class="character-color">Aloof Personality Profile</span>.  It can seem as if you are observing the world from outside rather than participating in it and your beliefs may differ from the mainstream.   You may even feel a lack of direction in life and perhaps you have a vivid imagination and imagine fantasy worlds.  It may be that you feel like you are "acting" rather than being yourself and, sometimes, you can be eloquent and others inarticulate.  It could also be that your outward appearance may even contradict what you are really feeling.  Some may say you are uncaring or apathetic but, inside, you have many creative and original moments as well as deeply, or even passionately, enjoing certain areas of interest to you.',
      value: [3, 2],
      categories:
        {
          OPENESS: 2,
    ...
    'Self-critical': {
      title: 'Self-critical',
      tag: 'MBTI INTP',
      showText: 'As the name suggests, <span class="character-color">Self-critical Personalities Profile</span> are hard on themselves.  They things they do as worthless and themselves as insignificant without justification and when the reality may well be different.  These traits can make them feel a combination of gloomy, miserable, unhappy or troubled when the reality is actually likely to be different.  The pessimism can lead to a negative cycle of judgmental thoughts that can manifest as cynicism and make otherwise positive situations look and feel bleak.  However, the negative thoughts general stem from not accepting the reality of a situation and, once things more in perspective, things can seem brighter.',
      value: [4, 3.15],
      categories:
        {
          OPENESS: 3,
    ...
    Anxious: {
      title: 'Anxious',
      tag: 'MBTI ENFP',
      showText: 'We think <span class="character-color">Anxious Personality Types</span> rely on others when it comes to making decisions.  They are very agreeable in that they adapt to the company they are in but aren\'t confident in expressing their thoughts.  They may feel pressure in decision-making situations which makes them defer to others.   This can lead to over-reliance on others and a sense of isolation and loneliness when alone.  The lack of confidence means that Anxious Types can also be pessimistic and reaction to changing circumstances rather than assessing the situation in a more calm way.  By delegating a lot of decision making and responsibility to others, together with being introvert, can make Anxious Personality Types appear passive.',
      value: [4.15, 4.15],
      categories:
        {
          OPENESS: 2,
    ...
    Procrastinator: {
      ...
      tag: 'MBTI ENFJ',
      showText: 'You are a <span class="character-color">Procrastinator Personality Type</span>.  You see yourself as a moderator, committing to neither on side or another and also nonchalant, not caring about the outcome in a particular situtation.  On the other side, you can be challenging and reactive but, generally speaking, <span class="character-color">Procrastinator Personailty Types</span> appear neutral in situations and that\'s what make they type they are.  Procrastinators are reactive to situations but their reactions tend to come from an inner monologue that says "no" to things, which appears to others like they can\'t make a decision when asked.  The indecisiveness in Procrastinators mean they tend to moderate conflicts to subconsciously keep things unchanged and often appear as unconcerned with events.  Another way of Procrastinating is simply not to participate and hope the decision goes away which can appear to others as being a reserved person.',
      value: [5, -1],
      categories:
        {
          OPENESS: 3,
    ...
    Active: {
      title: 'Active',
      tag: 'MBTI INFP',
      showText: 'The <span class="character-color">Active Personality Profile</span> sees themselves a moderator but you can be ambivelent and apathetic.  On the other hand, you can be challenging with a reactive side.    Active Personality types can be inattentive and restless which can be disruptive the balance in social situations as can their impulsivity.  As will all personality types, there are varying degrees within each type but, at extreme levels, these behaviours can cause strain on relationships, both at home and work.  It may seem to others as if you are forgetful, not listening or even disorganised.  Some in this type may find it hard to start tasks, making them appear lazy or ambivalent, and then not finish them, giving the appearance of impulsively starting tasks.  The reluctance to start tasks due to a lack of focus can also appear to be challenging to those setting the task.',
      value: [6, -2],
      categories:
        {
          OPENESS: 3,
    ...
    Productive: {
      title: 'Productive',
      tag: 'MBTI INFP',
      showText: 'As a <span class="character-color">Productive Personality Type</span>, you see yourself as inquisitive and interested. Additionally, you can be adversarial but with a resilient side.  As a Productive Personality, you are resilient to setbacks, perserving to get things done inspite of setbacks. To acheive your goals, you can be determined even it is means ruffling a few feathers of those around you and you appear not too bothered about upsetting them either!  The task is everything and there isn\'t much room for feelings.  By being task-orientated, you can withdraw into your own world and appear reserved but it\'s just your focus dominating the task.  Productive Personality Type focus on the new and innovation rather the current or past state of affairs.',
      value: [6, 4],
      categories:
        {
          OPENESS: 4,
    ...
    Calm: {
      title: 'Calm',
      tag: 'MBTI INFP',
      showText: 'The way you answered suggests that you have <span class="character-color">Calm Personality Profile</span>; a moderator and focussed. Additionally, you are flexible which allows you stay calm in different situations.  Calm personalities are, as you might expect, unruffled by life\'s chaos.  They remain serene and swan-like throughout it all.  Being adaptable to change and others\' behaviours, the Calm personality accomodates change well.  Some of that may be due to the focus that Calm Personalities have, which is high compare to average.  Being a centred type of personality, neither being overtly extraverted or introverted, adds to the charateristics of being Calm.  You score highly on resilience which means that you can deal with setbacks easily without losing your placid, calm persona.',
      value: [6, 8],
      categories:
        {
          OPENESS: 3,
    ...
    Impulsive: {
      title: 'Impulsive',
      tag: 'MBTI INFP',
      showText: 'Your answers determined that you are what we classify as a <span class="character-color">Impulsive Personality Profile</span>.  The extreme form of this type includes traits such as emotional instability, distorted patterns of thinking or what we are know as "cognitive distortions", impulsive behaviour that cross over into the type of relationships they have.   Impulsive types often feel extreme emotions such as rage, sorrow, shame, panic and longer-term feeling of emptiness and loneliness.',
      value: [8, -1],
      categories:
        {
          OPENESS: 4,
